...
`KZzymtqctNdW4fWhLdWKRYUDGXP3KzG8Y9`

Andy's banana receive address:
`KiNMHYArytp2D6jQSPHrGd7rq3qAxvpdt5`

Barb's banana change address:
`KdahQMGWTJgFjziWadqejMU7gYAvpumzkk`

Barb's apple receive address:
`KtPia5TPzjw1XibYh3de3RKxcpq9gusCBu`

Andy's apple change address:
`KeW8oMzwyQZbgME9Tm633TDRV8bW347tEM`
...
`'{"KZzymtqctNdW4fWhLdWKRYUDGXP3KzG8Y9":4.8827125, \
  ...
  "KeW8oMzwyQZbgME9Tm633TDRV8bW347tEM":{"transfer":{"APPLES":998}}}'`
